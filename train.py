...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CMLP')
    ...
    parser.add_argument("--lr", type=float, default=0.005, help="learning rate, default = 0.005") # reddit 0.0001
    ...
    parser.add_argument('--n_cls_per_task', default=10, help='how many classes does each task  contain')
    ...
    parser.add_argument('--perform_testing', type=strtobool, default=False, help='whether to check the existence of processed data by loading')
